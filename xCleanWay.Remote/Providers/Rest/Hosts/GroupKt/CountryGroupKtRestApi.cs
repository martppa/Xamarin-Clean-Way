...
{
    public class CountryGroupKtRestApi : CountryRestApi<GroupKtCountryModel>
    {
        ...
        public CountryGroupKtRestApi(IRestFramework restFramework, RawCountryMapper rawCountryMapper) 
